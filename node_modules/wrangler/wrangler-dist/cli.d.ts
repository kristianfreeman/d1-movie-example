...
declare interface Cache_2 {
    match (request: RequestInfo_2, options?: CacheQueryOptions_2): Promise<Response_2 | undefined>,
    matchAll (request?: RequestInfo_2, options?: CacheQueryOptions_2): Promise<readonly Response_2[]>,
    add (request: RequestInfo_2): Promise<undefined>,
    addAll (requests: RequestInfo_2[]): Promise<undefined>,
    put (request: RequestInfo_2, response: Response_2): Promise<undefined>,
    delete (request: RequestInfo_2, options?: CacheQueryOptions_2): Promise<boolean>,
...
declare interface CacheStorage_2 {
    match (request: RequestInfo_2, options?: MultiCacheQueryOptions): Promise<Response_2 | undefined>,
...
declare const CacheStorage_2: {
    prototype: CacheStorage_2
    new(): CacheStorage_2
};
...
declare interface MultiCacheQueryOptions extends CacheQueryOptions_2 {
    cacheName?: string
}
...
declare namespace undici {
    export {
        ...
        serializeAMimeType,
        MIMEType,
        CacheStorage_2 as CacheStorage,
        Cache_2 as Cache,
        CacheQueryOptions_2 as CacheQueryOptions,
...
declare const WebSocket_2: {
    ...
    new (url: string | URL, protocols?: string | string[] | WebSocketInit): WebSocket_2
    readonly CLOSED: number
    readonly CLOSING: number
    readonly CONNECTING: number
    readonly OPEN: number
